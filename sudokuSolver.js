...
var SudokuSolver = function (testable) {
    ...
    //number can be inserted only if the same number is not present in the row, column and in its box
    ...
    //all the rows begin with index which are multiple of 9
    ...
    //other cols are basically addition of multiples of 9
